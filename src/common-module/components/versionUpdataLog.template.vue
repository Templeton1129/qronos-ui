...
const logList = {
  ...
  "0.5.3": [
    "📢 分享功能：首页支持账户级别分享海报，便于晒单",
    "📊 数据统计：新增仓位敞口数据展示，风险情况更清晰",
    "📥 框架扩展：支持自研框架导入，提升系统扩展能力",
    "🛠  修复问题：修复已知问题，提升整体稳定性",
    "🛡️ 代码风控：禁止shell脚本命令注入",
  ],
  "0.5.4": [
    "⚙️ 数据兼容：导入数据时兼容升级后的框架数据，不再执行清空处理",
    "🔧 功能修复：修复 rebalance_mode 通过导入修改后无法二次调整的问题",
    "⚙️ 配置更新：新增策略全局配置归档保存频率字段",
    "📊 数据修复：优化盈利/亏损币种统计精度问题",
    "🛠  体验优化：优化账户名称输入规则，禁止特殊字符",
  ],
};
